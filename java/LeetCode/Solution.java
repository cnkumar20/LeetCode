package LeetCode;// This is the text editor interface.s
...
class Solution {
    ...
    public boolean checkLimit(HashMap<Integer,Coins> input, int solidValue) {

        int total = 0;

        for(Integer value : input.keySet()) {
    ...
    public HashMap<Integer,Coins> changSolver(HashMap<Integer,Coins> inputCollection, int solidValue) {

        HashMap<Integer,Coins> result = new HashMap<Integer,Coins>();
